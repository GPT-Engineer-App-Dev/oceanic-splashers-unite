...
**Project**: oceanic-splashers-unite 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: A website for a club of open sea swimmers 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/oceanic-splashers-unite.git
cd oceanic-splashers-unite
npm i
